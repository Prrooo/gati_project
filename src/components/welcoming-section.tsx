    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2
            className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mb-8 md:mb-12 transition-all duration-1000 ${progress > 0.3 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
          >
          ...
          <p
            className={`text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed max-w-5xl mx-auto transition-all duration-1000 delay-300 ${progress > 0.5 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
          >
