  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <p
          className={`text-sm md:text-base font-medium tracking-widest uppercase mb-6 md:mb-8 transition-all duration-1000 delay-300 ${
        ...
        <h1
          className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light leading-tight mb-8 transition-all duration-1000 delay-500 ${
