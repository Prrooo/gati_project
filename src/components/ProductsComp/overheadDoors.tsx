    ...
    <div>
      ...
      <div className="flex gap-4">
        <div className="basis-3/5">
          ...
          <p className="opacity-70">We’re thrilled to introduce our builders to the Overhead Doors commercial lineup and its nationwide installer network. Simply request a quote at \[your website], and a local installer in your area will be in touch with a personalized estimate for your project.</p>
        </div>
        <div className="basis-2/5">
          <Image className="rounded-2xl" src='/images/career.jpg' alt="ig" width={400} height={300} />
        </div>
      </div>
      <h1 className="text-xl text-orange-500 mb-2">Multiple overhead door options that will fit to your exact specifications</h1>
      <p className="mb-4 opacity-70">Our lineup spans from rugged, industrial panel‑constructed doors to high‑speed, springless impact‑resistant rubber models—all engineered with deep expertise, innovative design, and competitive value. Whether you need sectional, steel, thermally‑efficient insulated sandwich, rolling, or springless doors, we have the perfect solution for your facility. For more details or to connect with an authorized dealer in your area, visit our website.</p>
      <div className="flex gap-4">
